...
input_data= pd.read_csv("Height_training.csv",skiprows = None , header = None )
output_data1 = pd.read_csv("box_test.csv",skiprows = None , header = None )
input_data1 = pd.read_csv("Height_test.csv",skiprows = None , header = None )
